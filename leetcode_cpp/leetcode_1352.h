#pragma once
#ifndef _LEETCODE_1352_H_
#define _LEETCODE_1352_H_
/*
 * @Github: https://github.com/Certseeds
 * @Organization: SUSTech
 * @Author: nanoseeds
 * @Date: 2020-02-16 10:51:20
 * @LastEditors: nanoseeds
 * @LastEditTime: 2020-02-16 11:10:01
*/
#include <vector>
#include <algorithm>
using std::fill;
...
Example:
Input:["ProductOfNumbers","add","add","add","add","add",
...
public:
    vector<int> nums;
    const int max_operatinos = 40000;
    Solution1352() {
        this->nums.reserve(max_operatinos);
    }
    void add(int num) {
        ...
        if (1 == num) {
            ...
            //memset(&nums[0], 0, sizeof(int) * nums.size());
            return;
        }
