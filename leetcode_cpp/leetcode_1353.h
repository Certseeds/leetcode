...
public:
    ...
    void test() {
        vector<vector<int>> vec1 = { {1,1},{2,2},{1,4},{3,4},{4,4} };
        vector<vector<int>> vec2 = { {1,1},{1,2},{2,2} };
        vector<vector<int>> vec3 = { {1,2},{1,2},{3,3},{1,5},{1,5} };
        vector<vector<int>> vec4 = { {2,2},{2,2},{2,2},{2,2},{1,10} };
        vector<vector<int>> vec5 = { {1,2},{2,3}, {3,4} };
        vector<vector<int>> vec6 = { {1,2},{1,2},{2,3}, {3,4} };
        vector<vector<int>> vec7 = { {1,10000} };
        vector<vector<int>> vec8 = { {1,1},{1,2},{1,3},{1,4},{1,5},{1,6},{1,7} };
        vector<vector<int>> vec9 = { {2,3 }, { 2,3 }, { 1,5 }, { 1,5 }, { 1,5 } };
