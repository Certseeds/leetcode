...
public:
	...
	void test() {
		vector<int> vec1 = { 10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10 };
		string str1 = "abcdefghijklmnopqrstuvwxyz";
		cout << numberOfLines(vec1,str1)[0] << " " << numberOfLines(vec1, str1)[1] << endl;
		vector<int> vec2 = { 4,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10 };
